...
from langchain_core.tools import tool  # Correct tool decorator import

# Initialize Ollama (make sure it's running locally)
...
class BrowserTool:
    ...
    def scrape_reddit(max_comments_per_post: int = 7) -> list:
        """Scrapes Reddit content from r/LocalLLaMA subreddit"""
        reddit = praw.Reddit(
